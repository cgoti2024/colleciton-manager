...
namespace Illuminate\Support\Facades {
     ...
     */        class Redirect {
         ...
         * @example `return Redirect::tokenRedirect('collections.view', ['id' => 1]);`
...
')
     ...
     */        class URL {
         ...
         * @param array $params Additional route params.
         * @param bool $absolute Absolute or relative?
         * @example `URL::tokenRoute('collections.view', ['id' => 1]);`
         * @example `<a href="{{ URL::tokenRoute('collections.view', ['id' => 1]) }}">Order #1</a>`
         * @return string
...
namespace  {
             ...
             */            public static function forPageAfterId($perPage = 15, $lastId = 0, $column = 'id')
            {
                            ...
                            /**
             * Remove all existing collections and optionally add a new order.
             *
